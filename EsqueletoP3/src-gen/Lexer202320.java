...
public final class Lexer202320 {
  ...
  public static Object initialize() {
    ...
    $try:try {
      ...
      $line=221;
      keyWords=$cast(ISet.class,$fix(GCollections.asSet("walk","leap","jump","drop","get","grab","letGo","turnto","turn","right","left","forward","back","while","repeat","times","if","else","facing","can","not","north","south","east","west","defProc","defVar","nop")));
      $line=222;
      ...
      $line=243;
      ((gold.structures.map.GHashTableMap)translation).put("letGo",'Q');
      $line=245;
      ((gold.structures.map.GHashTableMap)translation).put("nop",'.');
      $line=247;
      ...
      $line=258;
      ((gold.structures.map.GHashTableMap)translation).put("while",'M');
      $line=259;
      ((gold.structures.map.GHashTableMap)translation).put("repeat",'R');
      $line=260;
      ((gold.structures.map.GHashTableMap)translation).put("times",'A');
      $line=261;
